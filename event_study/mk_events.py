...
def mk_event_df(tic):
    """ Subsets and processes recommendations given a ticker and return a data_new
    ...
    1. Read the appropriate CSV file with recommendations into a data_new frame
    ...
    # ------------------------------------------------------------------------
    # Step 1. Read the appropriate CSV file with recommendations into a data_new
    # frame
    # ------------------------------------------------------------------------ 
    ...
    # The column 'firm' is already part of the source data_new, so we only need to
