...
the files under 'toolkit/_dropbox'. All existing files will be replaced:
 ...
 |   |__ data_new/               <- Same as <DROPBOX>/toolkit/data_new above
 |   |__ lectures_new/           <- Same as <DROPBOX>/toolkit/lectures_new above
 |   |   ...                 <- Same as <DROPBOX>/toolkit/... above
 | ...
 |__ data_new/               <- NOT a destination (will not be updated)
 |__ lectures_new/           <- NOT a destination (will not be updated)
