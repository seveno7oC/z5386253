...
Companion codes for the lecture on working with time-series data_new in Pandas
"""
import os
...
# ----------------------------------------------------------------------------
# String representing the data_new included in the object
print(dt_now)
...
#new_delta = dt.d11111111111111111111111111111atetime
#print(new_delta)
...
#didx = pd.to_datetime(prc['Data'], format='%Y-$m-%d')
#print(didx) 
...
# the value of 'Adj Close' in 15th trading day in March 2019
prc = pd.read_csv(CSVLOC, parse_dates=['Date'], index_col='Date')
result = prc.loc['2019-03'].iloc[14]
print(result.loc['Adj Close'])
