...
# Slices do not work as expected if the data_new is not sorted
...
# containing the data_new items at the positional indices:
...
# end data_new (obviously) is not part of the series
