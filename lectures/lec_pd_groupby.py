...
#print(type(data_new['date'])) # --> <class 'pandas.core.indexes.datetimes.DatetimeIndex'>
...
# By default, DataFrame.apply will apply the function to each column of the data_new frame
res  = '?'
#print(res) 
...
# ----------------------------------------------------------------------------
#   Creating copies of each row of a data_new frame
# ----------------------------------------------------------------------------
# First row of `df`
#ser = df.iloc[0] 
